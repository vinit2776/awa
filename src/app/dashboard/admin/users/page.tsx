...
export default async function UsersPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-lg font-medium">Users &amp; role assignment</h1>
        <p className="text-sm text-muted-foreground">{tenantUsers.length} users, {assignments.length} assignments in {tenant.name}</p>
      </div>
